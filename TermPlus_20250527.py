...
class SerialGUI:
    def __init__(self, root, center=True):
        ...
        self.about_menu.add_command(label="vesion 20250527", state="disabled")
    ...
    def run_custom_script(self):
        ...
        def wait_for(target_string, over_time):
            ...
            while time.time() - start_time < over_time:
                ...
                # 如果发生了删除操作，导致 last_index 大于 current_index，则根据self.last_auto_delete_lines记录中删除了多少行，重置 last_index 的坐标
